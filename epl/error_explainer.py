...
_PATTERNS = [
    # NameError patterns
    {"match": r"undefined variable ['\"]?(\w+)['\"]?", "category": "name", "explain": _explain_undefined_var},
    {"match": r"variable ['\"]?(\w+)['\"]? has not been (?:created|declared|defined)", "category": "name", "explain": _explain_undefined_var},
    {"match": r"undefined function ['\"]?(\w+)['\"]?", "category": "name", "explain": _explain_undefined_func},
    ...
    {"match": r"unexpected token ['\"]?(\w+)['\"]?", "category": "syntax", "explain": _explain_unexpected_token},
    # TypeError patterns
    {"match": r"cannot (add|subtract|multiply|combine|concatenate).*(?:string|text).*(?:integer|number|float|decimal)", "category": "type", "explain": _explain_type_mismatch},
    ...
    {"match": r"divide by zero|division by zero", "category": "runtime", "explain": _explain_divide_by_zero},
    {"match": r"index out of range|index.*bounds", "category": "index", "explain": _explain_index_out_of_range},
    {"match": r"key not found|key.*does not exist", "category": "runtime", "explain": _explain_key_not_found},
    {"match": r"maximum recursion|stack overflow", "category": "runtime", "explain": _explain_max_recursion},
    # ImportError patterns
    {"match": r"cannot find|module not found|import.*failed", "category": "import", "explain": _explain_import_error},
    # EPL-native patterns
    {"match": r'function ["\']?(\w+)["\']? has not been defined', "category": "name", "explain": _explain_function_not_defined},
    {"match": r'(?:parent )?class ["\']?(\w+)["\']? not found', "category": "name", "explain": _explain_class_not_found},
    {"match": r'["\']?(\w+)["\']? is not a class', "category": "type", "explain": _explain_not_a_class},
    {"match": r'cannot change constant ["\']?(\w+)["\']?', "category": "runtime", "explain": _explain_constant_reassign},
    {"match": r'(\w+)\(\) takes \d+ argument', "category": "runtime", "explain": _explain_wrong_arg_count},
    {"match": r'(?:list|text) index must be integer', "category": "type", "explain": _explain_list_index_type},
    ...
    {"match": r'cannot convert to (?:integer|decimal)', "category": "runtime", "explain": _explain_cannot_convert},
    {"match": r'has no property ["\']?(\w+)["\']?', "category": "type", "explain": _explain_property_not_found},
    {"match": r'cannot (?:add|subtract|negate|slice|index into)', "category": "type", "explain": _explain_type_mismatch},
    # Beginner mistakes (foreign language syntax)
    {
        "match": r"unexpected.*print\b", "category": "syntax",
    ...
    {
        "match": r"unexpected.*\bdef\b", "category": "syntax",
        "explain": lambda m, src, lines: (
    ...
    {
        "match": r"unexpected.*\bfor\b", "category": "syntax",
        "explain": lambda m, src, lines: (
